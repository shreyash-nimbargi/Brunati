...
const SignupForm = () => {
    ...
    return (
        <div style={{ width: '100%', maxWidth: '400px' }}>
            ...
            <p style={{ color: '#6e6e73', textAlign: 'center', marginBottom: '32px' }}>Welcome to Brunati.</p>

            <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
                <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
                    <label style={{ fontSize: '0.8rem', fontWeight: 600, color: '#1d1d1f' }}>NAME</label>
                    <input
                        type="text"
                        value={name}
            ...
            <p style={{ textAlign: 'center', marginTop: '24px', color: '#6e6e73' }}>
                Already have an account? <Link to="/signin" style={{ color: '#0066cc', textDecoration: 'none', fontWeight: 600 }}>Sign in</Link>
            </p>
        </div>
    );
};
