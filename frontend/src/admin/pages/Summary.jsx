        ...
        <div style={{ fontFamily: FONT, opacity: loading ? 0.6 : 1, transition: 'opacity 0.2s' }}>
            ...
            <div style={{ 
                ...
                <div style={{ paddingRight: 20 }}>
                    <h1 style={{ fontFamily: FONT, fontSize: '1.4rem', fontWeight: 700, color: '#1d1d1f', margin: 0, textTransform: 'none', letterSpacing: 'normal' }}>Dashboard</h1>
                    <p style={{ fontSize: '0.85rem', color: '#6e6e73', marginTop: 4, fontWeight: 400 }}>A quick look at how your business is doing today.</p>
                </div>
                <button 
